...
export type StreamingMetadata = {
  contentType: "start" | "informative" | "streaming" | "final";
  sequenceNumber?: number;  // Only present on informative / streaming messages
  streamEndReason?: "completed" | "expired" | "canceled";  // Only present on final messages
};
...
export interface StreamingChatMessageStartPayload extends MessageReceivedPayload {}
...
export interface StreamingChatMessageChunkReceivedPayload extends MessageEditedPayload {}
