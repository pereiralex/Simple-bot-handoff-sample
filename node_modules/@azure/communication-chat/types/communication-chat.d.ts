 ...
 */
export declare interface ChatClientOptions extends PipelineOptions {
}
...
/** Optional parameters. */
export declare interface RestListChatThreadsOptions extends coreHttp.OperationOptions {
...
/** Optional parameters. */
export declare interface RestListMessagesOptions extends coreHttp.OperationOptions {
...
/** Optional parameters. */
export declare interface RestListParticipantsOptions extends coreHttp.OperationOptions {
...
/** Optional parameters. */
export declare interface RestListReadReceiptsOptions extends coreHttp.OperationOptions {
...
export declare interface RestUpdateMessageOptions {
 ...
 */
export declare type SendTypingNotificationOptions = OperationOptions;

/**
 * Options to update a chat message.
 */
export declare interface UpdateMessageOptions extends RestUpdateMessageOptions, OperationOptions {
}
